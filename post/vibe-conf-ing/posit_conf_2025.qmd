...
We could jump right in because the Posit team does reconnaissance beforehand, looking through [tidyverse](https://www.tidyverse.org), [r-lib](https://r-lib.r-universe.dev/packages), and [tidymodels](https://www.tidymodels.org) issues good for beginners. They print snippets on post-it notes for the "issue wall" where participants choose what to work on. Once you open a PR, you get to ring "The Gong" – and if you open multiple PRs, you ring it multiple times:
