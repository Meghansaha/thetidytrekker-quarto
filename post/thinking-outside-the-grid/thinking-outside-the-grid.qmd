...
```{r codesnip14, results='hide', fig.align="center", echo = TRUE, fig.show='hide', eval = FALSE}
...
```{r codesnip31, fig.cap="Planet Quad - Finished", fig.align="center", echo = TRUE, eval = FALSE}
